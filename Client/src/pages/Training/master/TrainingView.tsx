    ...
    <div className="min-h-screen bg-linear-to-br from-purple-50 via-blue-50 to-orange-50 border border-orange-300 m-1 rounded-md p-2 sm:p-6">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between mb-2">
          <div>
            <h1 className="text-lg sm:text-xl font-bold text-orange-600">Training List</h1>
            <p className="text-orange-400 mt-1 text-md">Manage training materials</p>
          </div>
        </div>
            ...
            <table className="w-full min-w-[500px]">
              ...
              <tbody className="bg-white divide-y divide-gray-200">
                {loading ? (
                  ...
                  data?.map((item) => (
                    <tr key={item?.training_id} className="hover:bg-orange-50 transition-colors duration-150">
