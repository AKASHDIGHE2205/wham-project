      ...
      <div className="max-w-2xl mx-auto">
        ...
        <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-2 mb-6 transform hover:shadow-md transition-all duration-300">
          <div className="flex items-center space-x-4">
            ...
            <div>
              <h1 className="text-xl font-bold text-indigo-600">Add New Training</h1>
              <p className="text-indigo-500">Create a new training material</p>
            </div>
          </div>
        </div>
        ...
        <div className="bg-white rounded-xl shadow-lg border border-gray-200 p-6">
          <form className="space-y-6" onSubmit={handleSubmit}>
            ...
            <div className="border-b border-gray-200 pb-4">
              <h2 className="font-semibold text-indigo-600 mb-4">Training File</h2>
              <div className="flex items-center space-x-6">
                <div className="shrink-0">
                  {selectedFile.preview ? (
                    ...
                    <div className="h-24 w-24 rounded-lg bg-gray-100 border-2 border-indigo-300 flex items-center justify-center text-4xl">
                      {getFileIcon()}
                    </div>
                  ) : (
              ...
              <div className="mb-4">
                ...
                <div className="relative group">
                  ...
                  <textarea
                    ...
                    className="w-full pl-10 pr-4 py-2 border border-gray-300 text-black rounded-lg focus:ring-0 focus:ring-indigo-500 focus:border-indigo-500 outline-none transition-all duration-200 resize-none"
                  />
                </div>
              </div>
