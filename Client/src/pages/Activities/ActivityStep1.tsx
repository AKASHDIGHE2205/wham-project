...
export const ActivityStep1: React.FC<ActivityStep1Props> = ({ formData, updateFormData, onNext }) => {
            ...
            <div>
              ...
              <div className="flex w-full mb-2">
                ...
                <button
                  ...
                  className="px-3 py-2 border border-l-0 border-gray-300 rounded-r-md flex items-center justify-center cursor-pointer bg-purple-50 hover:bg-purple-100"
                >
        ...
        <div className="space-y-2">
          <div className="grid grid-cols-1 gap-4">
            {formData?.occasion === 1 && (
              <div>
                {/* Colleges Section */}
                <div className="border border-gray-200 rounded-lg overflow-hidden p-2 m-1">
                  <div>
                    <label className="block text-sm font-semibold text-gray-700 mb-1">
                      College{" "}
                    ...
                    <div className="flex w-full mb-2">
                      ...
                      <button
                        ...
                        className="px-3 py-2 border border-l-0 border-gray-300 rounded-r-md bg-purple-50 flex items-center justify-center cursor-pointer"
                      >
