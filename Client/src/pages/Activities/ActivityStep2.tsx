...
export const ActivityStep2: React.FC<ActivityStep2Props> = ({ formData, updateFormData, onNext, onPrevious }) => {
        ...
        <div>
          ...
          <div className="flex w-full mb-3">
            ...
            <button
              ...
              className="px-3 py-2 border border-l-0 border-gray-300 rounded-r-md flex items-center justify-center cursor-pointer bg-purple-50 hover:bg-purple-100 transition-colors"
