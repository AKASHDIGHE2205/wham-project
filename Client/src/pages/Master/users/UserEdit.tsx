          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div>
              ...
              <input
                ...
                className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-0 focus:ring-indigo-500 focus:border-indigo-500 outline-none transition-all duration-200 bg-gray-100 cursor-not-allowed"
                required
                readOnly
              />
            </div>
            ...
            <div >
              <label className="block text-sm font-medium text-gray-700 mb-2">
                isorganizer Role <span className="text-indigo-600">*</span>
              </label>
