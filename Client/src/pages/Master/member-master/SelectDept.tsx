...
import { handleSelectDepartment } from "../../../feature/masterSlice";
...
const SelectDept: FC<Props> = ({ show, setShow }) => {
  ...
  const handleSelect = (department: Department) => {
    dispatch(handleSelectDepartment({ id: department?.dept_id, name: department?.dept_name }))
    setShow(false);
  };
