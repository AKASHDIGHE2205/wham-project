  ...
  return (
    <>
      ...
      <div
        ...
        role="dialog"
        aria-modal="true"
        aria-label={isEdit ? "Edit Department" : "View Department"}
      >
            ...
            <form className="space-y-6" onSubmit={handleSubmit}>
              ...
              <div>
                ...
                <div className="relative group">
                  ...
                  <input
                    ...
                    className="w-full pl-10 pr-4 py-2 border border-gray-300 rounded-lg focus:ring-0 focus:ring-indigo-500 focus:border-indigo-500 outline-none transition-all duration-200 disabled:cursor-not-allowed disabled:bg-gray-50"
                    required
                  />
                </div>
              </div>
              ...
              <div>
                ...
                <div className="flex gap-2">
                  ...
                  <button
                    ...
                    disabled={!isEdit}
                    className="px-4 py-2 bg-linear-to-r from-indigo-600 to-purple-600 hover:from-indigo-700 text-white font-medium rounded-lg hover:shadow-lg transition-all duration-200 cursor-pointer whitespace-nowrap disabled:cursor-not-allowed disabled:opacity-50"
                  >
              ...
              <div>
                ...
                <div className="relative group">
                  ...
                  <select
                    name="status"
                    className="w-full pl-10 pr-4 py-2 border border-gray-300 rounded-lg focus:ring-0 focus:ring-indigo-500 focus:border-indigo-500 outline-none appearance-none bg-white cursor-pointer disabled:cursor-not-allowed disabled:bg-gray-50"
                    required
                    value={inputs.status}
                    onChange={handleInputChange}
                    disabled={!isEdit}
