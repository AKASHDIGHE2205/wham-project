...
const NewTeam: FC<Props> = ({ show, setShow, fetchData }) => {
  ...
  const managerName = [first_name, middle_name, last_name].filter(Boolean).join(" ");
            ...
            <form className="space-y-5" onSubmit={handleSubmit}>
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full pl-10 pr-4 py-2.5 border border-gray-300 rounded-lg focus:ring-0 focus:ring-indigo-500 focus:border-indigo-500 outline-none transition-all duration-200"
                    required
                  />
                </div>
              </div>
              ...
              <div>
                ...
                <div className="flex gap-2">
                  ...
                  <button
                    type="button"
                    className="px-4 py-2.5 text-sm font-medium text-white bg-linear-to-r from-indigo-600 to-purple-600 hover:from-indigo-700 rounded-lg hover:shadow-lg transition-all duration-200 flex items-center gap-2 cursor-pointer whitespace-nowrap"
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <select
                    ...
                    value={inputs.status}
                    onChange={handleChange}
                    className="w-full pl-10 pr-4 py-2.5 border border-gray-300 rounded-lg focus:ring-0 focus:ring-indigo-500 focus:border-indigo-500 outline-none appearance-none bg-white cursor-pointer"
                    required
                  >
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <textarea
                    ...
                    className="w-full pl-10 pr-4 py-2.5 border border-gray-300 rounded-lg focus:ring-0 focus:ring-indigo-500 focus:border-indigo-500 outline-none resize-none transition-all duration-200"
                  />
                </div>
              </div>
