...
const TeamView = () => {
  ...
  return (
    <>
      <div className="min-h-screen bg-white p-2 sm:p-6 border border-orange-300 m-1 rounded-md">
        <div className="max-w-7xl mx-auto">
          {/* Header */}
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between mb-4">
            <div>
              <h1 className="text-2xl sm:text-3xl font-bold text-orange-600">Team Master</h1>
              <p className="text-orange-400 mt-1 sm:mt-2 text-sm sm:text-base">Manage your organization teams.</p>
            </div>
          </div>
